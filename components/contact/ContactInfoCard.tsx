    ...
    <div className="space-y-8 pr-0 lg:pr-6">
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-start gap-4">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-950 via-altiusNavy to-altiusBlue text-altiusGold flex items-center justify-center shrink-0 shadow-sm border border-altiusGold/30">
      ...
      <div className="pt-4">
        ...
        <div className="flex items-center gap-3">
          {['f', 'in', 't', 'y'].map((social, i) => (
            <div key={i} className="w-8 h-8 rounded-lg bg-gradient-to-br from-blue-950 via-altiusNavy to-altiusBlue text-altiusGold flex items-center justify-center text-xs font-bold hover:opacity-90 transition cursor-pointer shadow-sm border border-altiusGold/20">
              {social}
            </div>
          ))}
        </div>
