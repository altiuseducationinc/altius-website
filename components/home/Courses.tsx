  ...
  return (
    <section className="py-24 px-6 bg-altiusLight text-altiusNavy overflow-hidden">
        ...
        <div className="flex gap-6 shrink-0 animate-marquee">
          {[...programs, ...programs].map((program, index) => (
            <div
              key={index}
              style={{ borderRadius: '10px', width: '320px' }}
              /* Added group and hover pause utility directly to each card */
              className="group bg-white p-8 border border-gray-200/80 shadow-sm hover:shadow-md hover:[animation-play-state:paused] transition duration-300 flex flex-col justify-between space-y-6 shrink-0"
            >
              <div className="space-y-4">
                <div className="w-12 h-12 rounded-full bg-gradient-to-tr from-blue-950 via-altiusNavy to-blue-900 text-altiusGold flex items-center justify-center shadow-sm">
                  {program.icon}
      ...
      <style jsx global>{`
        ...
        /* Ensures individual card hovers pause the parent row's animation */
