...
const team = [
  { name: 'Career Mentors', role: 'Discover → Launch Journey Guides', image: '/student1.webp', icon: Compass },
  { name: 'Pathway Specialists', role: 'Engineering, Business, Media & Trades', image: '/student2.webp', icon: Network },
  { name: 'Technology Instructors', role: 'Coding, AI, CAD & 3D Printing', image: '/student3.webp', icon: Code2 },
  { name: 'Industry & Workplace Guides', role: 'Co-op, Interviews & Career Readiness', image: '/student4.webp', icon: BriefcaseBusiness },
];
